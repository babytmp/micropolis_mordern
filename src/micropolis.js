...
var fallbackImage, tileSet, snowTileSet, nightTileSet;
...
var onTilesLoaded = function() {
  ...
  var nightTiles = $('#nighttiles')[2]; // nighttiles 이미지 DOM에서 가져오기
  nightTileSet = new TileSet(nightTiles, onAllTilesLoaded, onFallbackTilesLoaded);  
};
...
var onAllTilesLoaded = function() {
  ...
  if (sprites.complete) {
    ...
    var s = new SplashScreen(tileSet, snowTileSet, sprites, nightTileSet);
  } else {
