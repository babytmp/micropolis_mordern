...
function Game(gameMap, tileSet, snowTileSet, spriteSheet, difficulty, name, nightTileSet) {
  ...
  this.nightTileSet = nightTileSet; // nightTileSet 저장
...
Game.prototype.handlePause = function(speed) {
    console.log('SPEED_CHANGE 이벤트 값:', speed); // 값 출력
